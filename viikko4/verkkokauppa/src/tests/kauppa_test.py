...
class TestKauppa(unittest.TestCase):
    ...
    def test_kutsutaan_tilisiirto_oikein(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
...
#nimi, viitenumero, tililta, tilille, summa
    ...
    def test_ostetaan_kaksi_tuotetta(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_ei_lisätä_loppunutta_tuotetta(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_tuote_poistetaan(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
