...
class TestOstoskori(unittest.TestCase):
    ...
    def test_kahden_eri_tuotteen_lisäyksen_jälkeen_ostoskorissa_kaksi_ostosta(self):
        maito = Tuote("Maito", 3)
        peruna = Tuote("paruna", 1)
        self.kori.lisaa_tuote(maito)
        self.kori.lisaa_tuote(peruna)
    ...
    def test_kahden_saman_tuotteen_lisäyksen_jälkeen_ostoskorissa_yksi_ostos(self):
        maito = Tuote("Maito", 3)
        self.kori.lisaa_tuote(maito)
        self.kori.lisaa_tuote(maito)
        ostokset = self.kori.ostokset()
    ...
    def test_kahden_saman_tuotteen_lisayksen_jälkeen_ostoskorissa_yksi_oikean_niminen_ostos(self):
        maito = Tuote("Maito", 3)
        self.kori.lisaa_tuote(maito)
        self.kori.lisaa_tuote(maito)
        ostos = self.kori.ostokset()[0]
    ...
    def test_jos_korissa_kaksi_samaa_tuotetta_ja_toinen_poistetaan_jää_koriin_tuote(self):
        maito = Tuote("Maito", 3)
        self.kori.lisaa_tuote(maito)
        self.kori.lisaa_tuote(maito)
    ...
    def test_jos_korin_ainoa_tuote_poistetaan_kori_on_tyhjä(self):
        maito = Tuote("Maito", 3)
        self.kori.lisaa_tuote(maito)
        self.kori.poista_tuote(maito)
        ostokset = self.kori.ostokset()
